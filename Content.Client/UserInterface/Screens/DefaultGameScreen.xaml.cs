...
{
    public static event Action<Control>? OnCreateTargeting; // Trauma
    ...
    public DefaultGameScreen()
    {
        ...
        CreateTargeting(Targeting); // Trauma

        Chat.OnResized += ChatOnResized;
        Chat.OnChatResizeFinish += ChatOnResizeFinish;

        MainViewport.OnResized += ResizeActionContainer;
        MainViewport.OnResized += ResizeAlertsContainer; // Trauma
    ...
    // <Trauma> - resizing alerts because of targeting
    ...
    internal static void CreateTargeting(Control targeting)
    {
        OnCreateTargeting?.Invoke(targeting);
    }
    // </Trauma>
